...
func readImagesFileinfo(image_dir string, file_paths chan string, num_images int) {
	...
	for i, fileinfo := range files {
		...
		file_path := path.Join(image_dir, fileinfo.Name())
...
func TestCompareGoldenPixelatedImages(t *testing.T) {
	...
	for chunk_size := 10; chunk_size < 60; chunk_size += 10 {
		...
		tests := map[string]struct {
			...
			"Aaron_Eckhart_0001": {input: "/home/chris/Documents/go_pixelate/pixelate_twoParts/testdata/Aaron_Eckhart_0001.png", golden: "Aaron_Eckhart_0001_chunksize" + strconv.Itoa(chunk_size)},
			"Adrien_Brody_0011":  {input: "/home/chris/Documents/go_pixelate/pixelate_twoParts/testdata/Adrien_Brody_0011.png", golden: "Adrien_Brody_0011_chunksize" + strconv.Itoa(chunk_size)},
		}
